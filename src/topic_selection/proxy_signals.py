...
from src.topic_selection.models import TopicCandidate, ProxySignals
...
class ProxySignalComputer:
    ...
    def _compute_persona_relevance(self, candidate: TopicCandidate) -> float:
        ...
        from src.topic_selection.models import TopicArchetype
        personal_impact = signals.archetypes.get(TopicArchetype.PERSONAL_IMPACT, 0.0)
        
        # 综合评分：基础0.3 + personal_impact加成
        relevance = min(1.0, personal_impact / 3.0 + 0.3)
