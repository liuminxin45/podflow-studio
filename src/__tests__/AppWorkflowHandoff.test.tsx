    ...
    currentWorkflow = {
      ...
      state: {
        ...
        facts: [{
          ...
          summary: '旧摘要',
          confidence: 'high',
          evidence: [{ id: 'stale-evidence', title: '旧来源', url: 'https://example.com/stale', published_at: '2026-07-19T00:00:00.000Z', source_role: 'background', excerpt: '旧摘要' }],
          claims: [{ id: 'stale-claim', text: '旧事实', evidence_ids: ['stale-evidence'], status: 'insufficient', confidence: 'low', verifier_model: '', verified_at: '' }],
        }],
