    ...
    return [
        {
            ...
            "content": "Researchers have developed a new transformer architecture that achieves state-of-the-art results on multiple NLP benchmarks. The model uses a novel attention mechanism that reduces computational complexity while maintaining high accuracy. This breakthrough could revolutionize how we process and understand human language in AI systems. " * 5,
        ...
        },
        {
            ...
            "content": "A modern programming language designed for systems programming has seen rapid adoption in the developer community. The language combines memory safety with performance, making it ideal for building reliable and efficient software. Major tech companies are already using it in production systems. " * 5,
